<# Mapped Printer Script created by sphinxpup on Reddit.com/r/PowerShell; modified and expanded by Shem Gyll #>

$cn = gethostlist #Read-Host "Enter Computer name (mdl123)"
$output = ''
...
$testnet = ''
    ...
    $holdArr | Export-Csv C:\temp\arr.csv -NoTypeInformation -Encoding ASCII
